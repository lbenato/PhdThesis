...
\usepackage{gensymb}
\usepackage{arydshln}
\usepackage{hyperref}%try to get pdf/a
...
\date{}
\author{\Large{ \textbf{Coordinatore:} Ch.mo Prof. Gianguido Dall'Agata \\ \textbf{Supervisore}: Ch.mo Prof. Franco Simonetto \\ \vspace*{1\baselineskip} \textbf{Dottoranda}: Lisa Benato}} %, {\itshape Universit\`a degli studi di Padova}}
...
\begin{large}
\vspace*{1.cm}
Sede Amministrativa: Universit\`a degli Studi di Padova \\ %The name your university
\vspace*{0.5\baselineskip}
Dipartimento di Fisica e Astronomia\\
\end{large}
\vspace{2.cm} %Put the distance you need.
\begin{huge}
