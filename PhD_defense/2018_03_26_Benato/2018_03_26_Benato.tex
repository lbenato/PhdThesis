...
\begin{itemize}
\small
\item[1.] Fit the whole MC spectra of $m_j$ for all the backgrounds with physical motivated functions
...
\centering
\includegraphics[height = 0.28 \textheight]{../../plotsAlpha_tesi/XVZnnhp/XZZInv_SignalNorm.pdf}
\end{column}
