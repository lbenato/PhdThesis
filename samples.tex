...
Kinematical distributions at generator level are shown in fig.~\ref{fig:genGravSignal1}-\ref{fig:genGravSignal3} for spin-2 bulk graviton signal, and in fig.~\ref{fig:genWprimeSignal1}-\ref{fig:genWprimeSignal3} for spin-1 HVT \Wp signal.
 ...
 \begin{figure}[!htb]
   \begin{center}
     ...
     \includegraphics[width=.495\textwidth]{Gen_v9/XZZInv_g_XPz.pdf}%GenPhi1y.pdf}
     %\\
     %\includegraphics[width=.495\textwidth]{Gen_v7/g_ZLepMass.pdf}%GenZmass.pdf}
     %\includegraphics[width=.495\textwidth]{Gen_v7/g_ZHadMass.pdf}%GenHmass.pdf}
     \\
   ...
   \end{center}
   \caption{Main signal kinematic quantities at generation level after parton showering, for spin-2 bulk graviton signal, considering different mass hypotheses ($m_{\G} = 0.6, 1, 2, 3, 4, 4.5$ TeV). Top: graviton rapidity $\mathcal{Y}$ and longitudinal momentum $p_z$. Center: pseudorapidity $\eta$ of the invisibly decaying \Z, and pseudorapidity of the leading neutrino. Bottom: pseudorapidity $\eta$ of the hadronically decaying \Z, and pseudorapidity of the leading quark.}
 ...
 \begin{figure}[!htb]
   \begin{center}
     ...
     \includegraphics[width=.495\textwidth]{Gen_v9/XWZInv_g_XPz.pdf}%GenPhi1y.pdf}
     %\\
     %\includegraphics[width=.495\textwidth]{Gen_v7/g_ZLepMass.pdf}%GenZmass.pdf}
     %\includegraphics[width=.495\textwidth]{Gen_v7/g_ZHadMass.pdf}%GenHmass.pdf}
     \\
   ...
   \end{center}
   \caption{Main signal kinematic quantities at generation level after parton showering, for spin-1 \Wp signal, considering different mass hypotheses ($m_{\Wp} = 0.6, 1, 2, 3, 4, 4.5$ TeV). Top: \Wp rapidity $\mathcal{Y}$ and longitudinal momentum $p_z$. Heavier \Wp ($m_{\Wp} \geq 4$ TeV) are produced in $q \bar{q}'$ scattering with a larger boost along the $z$ axis, hence with non-zero rapidity: this results in a double peak structure in the $\mathcal{Y}$ distribution, due to the presence of two different \Wp populations, holding respectively a significant positive or negative $p_z$ component. Center: pseudorapidity $\eta$ of the invisibly decaying \Z, and pseudorapidity of the leading neutrino. Bottom: pseudorapidity $\eta$ of the hadronically decaying \W, and pseudorapidity of the leading quark.}
...
\begin{figure}[!htb]
 ...
 \caption{Production cross-sections of the standard model processes involving a vector boson in association with jets, as measured by CMS, and theoretical predictions. These phenomena represent the main background sources for the analysis.~\cite{CMSCrossSectionsPublicResults}}
