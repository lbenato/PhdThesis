...
%
%Vertex: in object section. The helicoidal trajectories of the charged particles in the CMS magnetic field are described by two additional parameters, other than the curvature and the transverse and azimuthal angles: the transverse impact parameter $d_0$ and the longitudinal impact parameter $z_0$. The impact parameters are defined as the distance of maximum approach of the track to the primary vertex of the collision.
...
\begin{figure}[!htb]
  \centering
    \includegraphics[width=.5\textwidth]{figures/JetPlots/RelResVsJetPt_JetEta0to0p5_Mu_80x-1.pdf}%
    \includegraphics[width=.5\textwidth]{figures/JetPlots/RelResVsJetPt_JetEta3p2to4p7_Mu_80x-1.pdf}
\\
\includegraphics[width=.5\textwidth]{figures/JetPlots/JER_SF.png}
...
The PF \MET is the negative sum of the transverse momenta of the PF candidates reconstructed in the event. Inefficiencies in the tracker reconstruction and non-linear responses of the calorimeters can be corrected by propagating the jet energy corrections to \met:
\begin{equation}
...
The topology of the final state affects the \MET uncertainties; hence, they are factorized considering the effects 

To estimate the uncertainty
on the \MET, one can factorize it into its components of jets, electrons, muons, taus, photons
and jets of \pt $<$10 GeV and PF candidates not within jets (defined as the unclustered energy)
and vary each object within its scale and resolution uncertainties.  For the unclustered energy
uncertainty the low energy PF particles are further divided into groups to account for the res-
olution effect of different detector components: charged PF hadrons (dominated by the tracker
resolution), neutral PF hadrons (dominated by the HCAL resolution), photon PF candidates
(dominated by the ECAL resolution) and PF candidates associated with the forward hadronic
(HF) calorimeter (dominated by the forward HCAL resolution).  The largest contributions to
the unclustered energy uncertainty are due to the neutral PF hadrons and HF PF candidates.
The magnitude of the uncertainties due to jet energy scale correction and unclustered energy
scale variations are found to be 5\% and 30\% respectively in an inclusive ttbar simulation.

%\begin{figure}[!htb]
%  \centering
%    \includegraphics[width=.5\textwidth]{figures/MetPlots/TypeI_corr.pdf}%
%    \includegraphics[width=.5\textwidth]{figures/MetPlots/TypeI_corr.pdf}
%
%  \caption{.....}
%  \label{fig:met_typeI}
